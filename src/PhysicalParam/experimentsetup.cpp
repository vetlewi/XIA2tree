...
DetectorInfo_t pDetector[] =
        {
                ...
                {48, f500MHz, labr, 15, 0},
                {49, f500MHz, labr, 16, 0},
                {50, f500MHz, labr, 17, 0},
                {51, f500MHz, labr, 18, 0},
                {52, f500MHz, labr, 19, 0},
                {53, f500MHz, labr, 20, 0},
                {54, f500MHz, labr, 21, 0},
                {55, f500MHz, labr, 22, 0},
                {56, f500MHz, labr, 23, 0},
                {57, f500MHz, labr, 24, 0},
                {58, f500MHz, labr, 25, 0},
                {59, f500MHz, labr, 26, 0},
                {60, f500MHz, labr, 27, 0},
                {61, f500MHz, labr, 28, 0},
                {62, f500MHz, labr, 29, 0},
                {63, f500MHz, labr, 0, 0},
